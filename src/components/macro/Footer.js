...
function Footer({ theme = themes.standard, footerRef = () => {} }) {
  ...
  return (
    <Flex
      ...
      flexDir="column"
    >
      <Flex maxWidth="1300px" flexDir="column" justifyContent="center" alignItems="center" alignSelf="center" width="100%">
        ...
        <Flex justify="space-between" w="100%" mt={['24px', '24px', '24px', '24px', '10px']} flexDir={['column', 'column', 'row']}>
          <Text
            fontSize={['16px', '16px', fontS17L15S2W3.size]}
            letterSpacing={fontS18L15S2W3.letterSpacing}
            fontWeight={fontS18L15S2W3.weight}
