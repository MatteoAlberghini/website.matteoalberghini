...
import { tech } from '../../../constants/resume'

// SECTION Constant export
export const ResumeTech = ({ theme = themes.standard, setRef = () => {} }) => {
  ...
  return (
    <Flex ref={(ref) => setRef(ref)} flexDir="row" maxW="1300px" mt="50px" alignSelf="center" w="100%" paddingStart="24px" paddingEnd="24px">
      <Flex flexDir="column" flex="1">
        ...
        {/* Experience */}
        {tech.map((e, index) => (
          <Flex flexDir={['column', 'column', 'column', 'column', 'row']} w="100%" mt={index === 0 ? '22px' : '28px'} key={e.label}>
